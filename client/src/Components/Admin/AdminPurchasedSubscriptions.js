...
const AdminPurchasedSubscriptions = () => {
    ...
    const fetchSubscriptions = async () => {
      try {
        const token = document.cookie
          ...
          ?.split("=")[1];
        const response = await axios.get("/api/purchased-subscription/all", {
...
export default AdminPurchasedSubscriptions;
