            ...
            {user.role === "admin" && (
              <li className="nav-custom nav-item mx-0 mx-lg-1 nav-link py-3 px-0 px-lg-3">
                ...
                >
                  ...
                  <i
                    className={
                      icon ? "fas fa-chevron-up" : "fas fa-chevron-down"
                    }
                  ></i>
                </a>
                <ul className="collapse list-unstyled" id="subscription">
                  <li>
                    <NavLink to="/admin/create-subscription">
                      Tạo Gói Đăng Ký
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/purchased-subscriptions">
                      Giao Dịch Mua Gói
                    </NavLink>
                  </li>
                </ul>
          ...
          <ul className="navbar-nav ml-auto">
            ...
            {user.role === "recruiter" && (
              <li className="nav-custom nav-item mx-0 mx-lg-1 nav-link py-3 px-0 px-lg-3">
                ...
                <ul className="collapse list-unstyled" id="subscription">
                  ...
                  <li>
                    <NavLink to="/my-subscriptions">Gói Đã Mua</NavLink>
                  </li>
                </ul>
              </li>
            )}
            <li className="nav-custom nav-item mx-0 mx-lg-1 nav-link py-3 px-0 px-lg-3">
              ...
              <ul className="collapse list-unstyled" id="pageSubmenu">
                {user.role === "candidate" && (
                  <li>
                    <a href={`/myCV/${user._id}-page=1`}>Hồ Sơ Đã Nộp</a>
                  </li>
                )}
                {user.role === "recruiter" && (
                  <>
